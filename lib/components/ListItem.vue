        ...
        <div class="list-item-content">
          <div class="list-item-content__main">
            ...
            <div class="line-one" :class="{'line-one--bold': bold}">
              <span v-if="hasTitle" class="line-one__title">
                {{ title }}
              </span>
              ...
              <span v-if="showDetails && hasDetailsSlot" class="line-one__details">
                <slot name="details" />
              </span>
            </div>
...
<script>
import Actions from '@nextcloud/vue/dist/Components/NcNcActions'
import CounterBubble from '@nextcloud/vue/dist/Components/NcNcCounterBubble'
...
export default {
  ...
  computed: {
    ...
    showDetails() {
      return (this.hasDetails || this.hasDetailsSlot) && (!this.displayActionsOnHoverFocus || this.forceDisplayActions)
    },
  ...
  methods: {
    ...
    checkSlots() {
      ...
      if (this.hasDetailsSlot !== !!this.$slots.details) {
        this.hasDetailsSlot = !!this.$slots.details
      }
    },
  },
}
